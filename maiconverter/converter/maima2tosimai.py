...
def convert_notes(simai_chart: SimaiChart, ma2_notes: Sequence[MaiNote]) -> None:
    for ma2_note in ma2_notes:
        ...
        if isinstance(ma2_note, TapNote):
            is_break = note_type in [NoteType.break_tap, NoteType.break_star, NoteType.break_tap_ex, NoteType.break_star_ex]
            is_ex = note_type in [NoteType.ex_tap, NoteType.ex_star, NoteType.break_tap_ex, NoteType.break_star_ex]
            is_star = note_type in [
                NoteType.star,
                NoteType.break_star,
                NoteType.ex_star,
                NoteType.break_star_ex,
            ]
            simai_chart.add_tap(
            ...
            is_ex = note_type in [NoteType.ex_hold, NoteType.break_hold_ex]
            is_break = note_type in [NoteType.break_hold, NoteType.break_hold_ex]
